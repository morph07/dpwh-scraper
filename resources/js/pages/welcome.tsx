...
export default function Welcome() {
    return (
        <>
            <Head title="DPWH Infrastructure Scraper">
                ...
                <div className="flex w-full items-center justify-center opacity-100 transition-opacity duration-750 lg:grow starting:opacity-0">
                    <main className="flex w-full max-w-[335px] flex-col-reverse lg:max-w-4xl lg:flex-row">
                        <div className="flex-1 rounded-br-lg rounded-bl-lg bg-white p-6 pb-12 text-[13px] leading-[20px] shadow-[inset_0px_0px_0px_1px_rgba(26,26,0,0.16)] lg:rounded-tl-lg lg:rounded-br-none lg:p-20 dark:bg-[#161615] dark:text-[#EDEDEC] dark:shadow-[inset_0px_0px_0px_1px_#fffaed2d]">
                            <h1 className="mb-6 text-4xl font-bold text-[#1b1b18] dark:text-[#EDEDEC]">
                                DPWH Infrastructure Scraper
                            </h1>
                            ...
                            <p className="mb-6 text-base text-[#706f6c] dark:text-[#A1A09A]">
                                Track and monitor Department of Public Works and Highways (DPWH) infrastructure projects across the Philippines.
                                Access real-time data on project status, funding, and changes for transparency and accountability.
                            </p>

                            <div className="mb-6 space-y-4">
                                <h3 className="text-lg font-medium text-[#1b1b18] dark:text-[#EDEDEC]">Quick Access</h3>
                                <ul className="grid gap-4 sm:grid-cols-3">
                                    <li>
                                        <Link
                                            href={dashboard()}
                                            className="block p-4 rounded-lg border border-[#e3e3e0] bg-[#FDFDFC] hover:border-[#1915014a] hover:shadow-md transition-all dark:border-[#3E3E3A] dark:bg-[#161615] dark:hover:border-[#62605b]"
                                        >
                                            <div className="flex items-center gap-3">
                                                ...
                                                <div>
                                                    <h4 className="font-medium text-[#1b1b18] dark:text-[#EDEDEC]">Dashboard</h4>
                                                    <p className="text-sm text-[#706f6c] dark:text-[#A1A09A]">Overview & Stats</p>
                                                </div>
                                            </div>
                                        </Link>
                                    </li>
                                    <li>
                                        ...
                                        >
                                            <div className="flex items-center gap-3">
                                                ...
                                                <div>
                                                    <h4 className="font-medium text-[#1b1b18] dark:text-[#EDEDEC]">Projects</h4>
                                                    <p className="text-sm text-[#706f6c] dark:text-[#A1A09A]">Browse All Projects</p>
                                                </div>
                                            </div>
                                        </Link>
                                    </li>
                                    <li>
                                        ...
                                        >
                                            <div className="flex items-center gap-3">
                                                ...
                                                <div>
                                                    <h4 className="font-medium text-[#1b1b18] dark:text-[#EDEDEC]">Changes</h4>
                                                    <p className="text-sm text-[#706f6c] dark:text-[#A1A09A]">Track Updates</p>
                                                </div>
                                            </div>
                                        </Link>
                                    </li>
                            ...
                            <div className="space-y-4">
                                <h3 className="text-lg font-medium text-[#1b1b18] dark:text-[#EDEDEC]">About This System</h3>
                                <ul className="space-y-3 text-sm text-[#706f6c] dark:text-[#A1A09A]">
                                    <li className="flex items-start gap-3">
                                        <span className="flex h-6 w-6 items-center justify-center rounded-full bg-blue-100 text-blue-600 dark:bg-blue-900/30 dark:text-blue-400 text-xs font-medium">
                                            ✓
                                        </span>
                                        <span>Real-time monitoring of DPWH infrastructure projects</span>
                                    </li>
                                    <li className="flex items-start gap-3">
                                        <span className="flex h-6 w-6 items-center justify-center rounded-full bg-green-100 text-green-600 dark:bg-green-900/30 dark:text-green-400 text-xs font-medium">
                                            ✓
                                        </span>
                                        <span>Automated change detection and tracking</span>
                                    </li>
                                    <li className="flex items-start gap-3">
                                        <span className="flex h-6 w-6 items-center justify-center rounded-full bg-purple-100 text-purple-600 dark:bg-purple-900/30 dark:text-purple-400 text-xs font-medium">
                                            ✓
                                        </span>
                                        <span>Public access for transparency and accountability</span>
                                    </li>
                                </ul>
                            </div>
                        </div>
